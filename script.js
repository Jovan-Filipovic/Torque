/* -------------------------------------------------------
: This file is script file of the Torque_1
: webpage to calculate torque values
: by yoyomaji 
: (c)2025 All rights reserved 
------------------------------------------------------- */

// Script to clear values from the input
...
function load_example() {
	...
	document.getElementById("Re").value = "615.0";
...
// Script to calculate values from the input
function calculate() {
	// get input values
...
// Function to close current tab page in browser and open new one
...
// JavaScript to set variable for dynamic date and time
...
// Script to automate update date and time every second
